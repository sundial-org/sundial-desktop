...
export function buildLocalAgentInstructions({
  ...
  return [
    ...
    '',
    'Watch for my review feedback with ONE blocking call after you edit — it long-polls (no',
    'repeated polling) and returns my new comments when I leave them:',
    ...
    'When it returns a comment, do what it asks (you may web-search to back a claim), reply via',
    'POST /comments/<threadId>/messages, revise the file, then call it again with the returned',
    '"cursor" as the next since.',
    '',
